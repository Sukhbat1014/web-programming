  ...
  render() {
    return (
      ...
      <div className="container example">
        <Header/>
        <h4>React:</h4>
        <div className="motto-update"> Motto: &nbsp;
        <input minLength="20" className="markdown-content" onChange={this.handleChange} defaultValue={this.state.inputValue}
        />
        </div>
        <div className="motto-reading">
